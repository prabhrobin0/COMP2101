...
function error-message {
  echo "Something got stuck! Sorry pal! $1" >&2
}
...
function error-exit {
  echo "Something got stuck! Sorry pal! This may help! $?"
  exit
}
#This function displays help information if the user asks for it on the command line or gives us a bad command line
function displayhelp {
  echo "
THIS SCRIPT SHOWS SYSTEM CONFIGURATION SETTINGS
ARGUMENTS: -
-h | --help ,, --host ,, --domain ,, --ipconfig ,, --os ,, --cpu ,, --memory ,, --disk ,, --printer"
}
...
function cleanup {
  rm /tmp/*.$$ && echo "tmp files removed for this process"
  exit
}
# Trapping exit signal to clear the temporary files
trap cleanup SIGINT
